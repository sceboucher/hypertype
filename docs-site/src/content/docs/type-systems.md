...
description: "How to emit a coherent type system instead of scattering one-off font sizes, and how"
---
...
[Using hierarchy well](/hypertype/hierarchy/): this file is about the system, that one is about the
