---
title: "Using hierarchy well"
description: "Hierarchy is not a property of any single element; it lives in the relationships between"
---
...
the fix. The companion [Building a type system](/hypertype/type-systems/) builds the scale; this one puts
it in relationship.
